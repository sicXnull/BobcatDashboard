...
- 0.2.19
1. Fix website icon for Bobcat2
...
4. Show SN in the footer, Only Bobcat2 (except CN470) support
...
3. Fix the issue that it always update failed when click update miner on some bobcats.
